 ...
 *
 */
public class DeleCreateOrganizationTest extends BaseClass {
	...
	public void createORgtest() throws Throwable {
	   ...
	   driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
	    ...
	    /* step 8 :select org to del*/
		driver.findElement(By.id("145")).click();
