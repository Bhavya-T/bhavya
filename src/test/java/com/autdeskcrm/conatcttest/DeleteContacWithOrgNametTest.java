 ...
 *
 */
public class DeleteContacWithOrgNametTest extends BaseClass{
	...
	driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
		...
		driver.findElement(By.id("126")).click();
		
		driver.findElement(By.xpath("//input[@class='crmbutton small delete']")).click();
		
		wLib.alertOk(driver);
		
		driver.findElement(By.xpath("//input[@class='txtBox']")).sendKeys(contactName);
